# ============================================================================
# HR Calculator - 최종 아키텍처 v9.0 (DuckDB I/O + Job Queue 전략 + 워커별 로그 Queue 분리(v6에서는 성공의 경우는 중앙, 실패는 분리)) + '쓰기 일괄 처리(Write Batching)' 추가 + 트랜잭션 통합(Transactional Integration)
# ============================================================================
#
